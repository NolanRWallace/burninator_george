...
walkRight = [pygame.image.load('hero/hero_right.png'), pygame.image.load(
    'hero/hero_right_walk1.png'), pygame.image.load('hero/hero_right_walk2.png')]
walkLeft = [pygame.image.load('hero/hero_left.png'), pygame.image.load(
    'hero/hero_left_walk1.png'), pygame.image.load('hero/hero_left_walk2.png')]
walkUp = [pygame.image.load('hero/hero_back.png'), pygame.image.load(
    'hero/hero_back_walk1.png'), pygame.image.load('hero/hero_back_walk2.png')]
walkDown = [pygame.image.load('hero/hero_front.png'), pygame.image.load(
    'hero/hero_front_walk1.png'), pygame.image.load('hero/hero_front_walk2.png')]
swordRight = [pygame.image.load('hero/sword_idle_right.png'), pygame.image.load(
    'hero/sword_right_walk1.png'), pygame.image.load('hero/sword_right_walk2.png')]
swordLeft = [pygame.image.load('hero/sword_idle_left.png'), pygame.image.load(
    'hero/sword_left_walk1.png'), pygame.image.load('hero/sword_left_walk2.png')]
swordUp = [pygame.image.load('hero/sword_idle_back.png'), pygame.image.load(
    'hero/sword_back_walk1.png'), pygame.image.load('hero/sword_back_walk2.png')]
swordDown = [pygame.image.load('hero/sword_idle_front.png'), pygame.image.load(
    'hero/sword_front_walk1.png'), pygame.image.load('hero/sword_front_walk2.png')]
swordAttackRight = [pygame.transform.scale(pygame.image.load(
    'hero/sword_right_attack1.png'), (32, 32)), pygame.transform.scale(pygame.image.load('hero/sword_right_attack2.png'), (32, 32))]
swordAttackLeft = [pygame.transform.scale(pygame.image.load(
    'hero/sword_left_attack1.png'), (32, 32)), pygame.transform.scale(pygame.image.load('hero/sword_left_attack2.png'), (32, 32))]
swordAttackUp = [pygame.transform.scale(pygame.image.load('hero/sword_back_attack1.png'), (32, 32)),
                 pygame.transform.scale(pygame.image.load('hero/sword_back_attack2.png'), (32, 32))]
swordAttackDown = [pygame.transform.scale(pygame.image.load('hero/sword_front_attack1.png'), (
    32, 32)), pygame.transform.scale(pygame.image.load('hero/sword_front_attack2.png'), (32, 32))]
    ...
    def draw(self, win):
        if self.visible:
            ...
            if self.swordAttack == True:
                if self.left:
                    win.blit(
                        swordAttackLeft[self.swordSlashCount//3], (self.x, self.y))
                    self.swordSlashCount += 1
                elif self.right:
                    win.blit(
                        swordAttackRight[self.swordSlashCount//3], (self.x, self.y))
                    self.swordSlashCount += 1
                elif self.up:
                    win.blit(
                        swordAttackUp[self.swordSlashCount//3], (self.x, self.y))
                    self.swordSlashCount += 1
                elif self.down:
                    win.blit(
                        swordAttackDown[self.swordSlashCount//3], (self.x, self.y))
                    self.swordSlashCount += 1
